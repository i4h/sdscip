...
$(MAINFILE):	githash $(BINDIR) $(OBJDIR) $(SCIPLIBFILE) $(LPILIBFILE) $(NLPILIBFILE) $(TPILIBFILE) $(MAINOBJFILES)
		@echo "-> linking $@"
...
$(UNITTESTFILE):	$(BINDIR) $(OBJDIR) $(SCIPLIBFILE) $(LPILIBFILE) $(NLPILIBFILE) $(TPILIBFILE) $(UNITTESTOBJFILES)
		@echo "-> linking $@"
